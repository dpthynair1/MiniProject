...
namespace CurrencyCoverter.CurrencyExchange
{
    ...
    public class Mobile : Product
    {
        ...
        public Mobile(string category, string prodName, string model, DateTime dateTime, double prodPrice)
        {
            Category = category;
            ProdName = prodName;
            this.model = model;
        ...
        public Mobile(string category, string location, string prodName, string modelName, DateTime purchaseDate, double price, string currentFormat)
        {
            Category = category;
            ProdName = prodName;
